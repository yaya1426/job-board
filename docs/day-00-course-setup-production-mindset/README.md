# Day (0) Course Setup & Production Mindset | إعداد الكورس وعقلية الإنتاج

## Goal

Set the expectations, product context, and engineering mindset for the course before implementation begins. Students should understand what they will build, how they will learn, and why the course ships a small production-realistic step from Day 1.

## Audience and prerequisites

This day is for developers who know the basics of HTML, CSS, JavaScript, React, Git, and command-line usage and want to move from following isolated tutorials to building and operating a complete product.

Students do not need prior experience with Next.js production deployments, MongoDB, authentication, file storage, or AI APIs. Those topics are introduced incrementally when the product needs them.
...
The day moves from the student’s goal to the course’s working method:
...
By the end of Day 0, the student can:
